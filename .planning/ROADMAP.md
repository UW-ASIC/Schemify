...
**Plans:** 3 plans
Plans:
- [ ] 08-01-PLAN.md — Fix build_plugin_helper.zig (FileIO.zig ref, utility module) + Theme.applyJson implementation
...
**Plans:** 2 plans
Plans:
- [ ] 14-01-PLAN.md — Directory restructure, file moves, internal link fixes, sidebar config update
...
| 8. Runtime Foundation | Planned (3 plans, 2 waves) | - |
...
| 14. Doc Infrastructure & Quick Start | Planned (2 plans, 2 waves) | - |
