...
Every Schemify project is rooted in a directory that contains a `Config.toml`.
The file is optional — if it is missing, Schemify starts with sensible defaults.
