...
const agent = if (is_wasm) struct { pub const McpServer = void; } else @import("core").agent;
...
fn agentGetSchematic(self: *agent.types.AgentContext) ?*const @import("core").Schemify {
