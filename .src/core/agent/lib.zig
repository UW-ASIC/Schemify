//! MCP Agent — deep module entry point.
//!
//! Exposes Schemify's schematic tools, resources, and prompts over a
//! Unix domain socket using the Model Context Protocol (JSON-RPC 2.0).
//!
//! Usage from main.zig:
//!   const agent = @import("agent");
//!   var mcp_server: ?agent.McpServer = null;
//!   // In appInit:
//!   mcp_server = agent.init(allocator, &app) catch null;
//!   // In appDeinit:
