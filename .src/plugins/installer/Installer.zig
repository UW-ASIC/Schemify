...
pub const InstallError = types.InstallError;
...
pub const Installer = struct {
    ...
    fn resolveGitHubRelease(allocator: std.mem.Allocator, gh_url: []const u8, tgt: Target) InstallError![]u8 {
    ...
    fn fetchUrl(allocator: std.mem.Allocator, url: []const u8) InstallError![]u8 {
