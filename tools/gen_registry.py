...
-----
  ...
  python3 tools/gen_registry.py --list-buildable

  # Override the release tag used for download URLs
  python3 tools/gen_registry.py --release-tag plugins-latest
...
def discover_plugins(
    ...
    for plugin_dir in sorted(PLUGINS_DIR.iterdir()):
        ...
        entry_dyl = entry_so.replace(".so", ".dylib")
        ...
        plugins.append({
            ...
            "download": {
                "linux": release_download_url(repo, release_tag, entry_so),
                "macos": release_download_url(repo, release_tag, entry_dyl),
            },
