...
Matches the Zig host in src/plugins/.

Install:
    pip install -e tools/sdk/python/      # editable from repo
...
class Plugin:
    ...
    def get_documentation(self) -> Optional[str]:
        """Get the active document's documentation text. Returns None if empty."""
        result = self._send_request("host/get_documentation", {})
