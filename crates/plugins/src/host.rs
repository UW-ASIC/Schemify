//! Host side of the plugin system: plugin.toml manifests, subprocess
//! transport, capability negotiation, message → [`PluginHostAction`]
//! decoding, and the [`PluginManager`] lifecycle/pump.
