...
pub fn dispatch(c: Command, state: *AppState) !void {
    switch (c) {
        ...
        => try @import("cmd/view.zig").handle(c, state),
        ...
        => try @import("cmd/selection.zig").handle(c, state),

        // ── Clipboard ─────────────────────────────────────────────────────
        .copy_selected, .clipboard_copy, .clipboard_cut, .clipboard_paste,
        => try @import("cmd/clipboard.zig").handle(c, state),
        ...
        => try @import("cmd/edit.zig").handle(c, state),
        ...
        => try @import("cmd/wire.zig").handle(c, state),
        ...
        => try @import("cmd/file.zig").handle(c, state),
        ...
        => try @import("cmd/hierarchy.zig").handle(c, state),

        // ── Netlist ───────────────────────────────────────────────────────
        .netlist_hierarchical, .netlist_flat, .netlist_top_only,
        .toggle_flat_netlist,
        => try @import("cmd/netlist.zig").handle(c, state),

        // ── Simulation ────────────────────────────────────────────────────
        .run_sim, .open_waveform_viewer,
        => try @import("cmd/sim.zig").handle(c, state),

        // ── Properties ────────────────────────────────────────────────────
        .edit_properties, .view_properties, .edit_schematic_metadata,
        => try @import("cmd/props.zig").handle(c, state),

        // ── Plugin ────────────────────────────────────────────────────────
        .plugin_command, .plugins_refresh,
        => try @import("cmd/plugin.zig").handle(c, state),

        // ── Undo / Redo ───────────────────────────────────────────────────
        .undo, .redo,
        => try @import("cmd/undo.zig").handle(c, state),
    }
}
