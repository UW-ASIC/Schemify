...
pub const discoverMeasurementsFromDecl = testbench.discoverMeasurementsFromDecl;
pub const testbenchReferencesDut = testbench.testbenchReferencesDut;
pub const DiscoveredDevice = testbench.DiscoveredDevice;
pub const discoverOptimizableDevices = testbench.discoverOptimizableDevices;
