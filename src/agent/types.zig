...
pub const AgentContext = struct {
    ...
    /// Set PySpice source code on the active schematic.
    setPySpiceSource: ?*const fn (*AgentContext, []const u8) bool = null,

    /// Get PySpice source code from the active schematic.
    getPySpiceSource: ?*const fn (*AgentContext) ?[]const u8 = null,

    /// Set documentation on the active schematic.
    setDocumentation: ?*const fn (*AgentContext, []const u8) bool = null,

    /// Get documentation from the active schematic.
    getDocumentation: ?*const fn (*AgentContext) ?[]const u8 = null,
