...
#### do not ask confirmation to simulate when pressing 's'
...
#### Replace Ctrl-q with Escape (so you won't kill the program)
...
#### defines the depth to descend into each path. default: 0
# set new_file_browser_depth 1
...
###########################################################################
#### FIX SOME REMOTE DESKTOP CONNECTION SOFTWARE NOT CORRECTLY REPORTING
